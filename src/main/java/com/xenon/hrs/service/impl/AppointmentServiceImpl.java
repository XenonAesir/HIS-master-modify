...
public class AppointmentServiceImpl implements AppointmentService
{
    ...
    @Override
    public int addremainDoctorNumber(RemainDoctorNumber remainDoctorNumber) {
        return remainDoctorNumberDao.insertSelective(remainDoctorNumber);
    }
